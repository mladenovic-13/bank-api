.PHONY: build migrate-up migrate-down migrate-test-up migrate-test-down generate test swag-init swag-fmt run
...
migrate-test-down:
	@goose -dir sql/schema postgres "$(TEST_DB_URL)" down 
